# -*- coding: utf-8 -*-
"""
Created on Fri Jul 20 10:58:12 2018
...
#data=pd.read_excel("data/All_data_Original_0716.xlsx").drop_duplicates()
data=pd.read_excel("data/All_data_0720.xlsx")
data=data.loc[data['bond_type_wind_1']!='短期融资券']
...
for i in range(1,20):
    ...
    ada = ADASYN(random_state=i,ratio=10/20)
