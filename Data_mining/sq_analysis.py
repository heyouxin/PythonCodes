...
s=pd.read_sql("select 申请（专利权）人 from sq_2011_2016",conn)
print (s)
conn.close()
s_str=str(s)

wordcloud = WordCloud(background_color="white",font_path='C:\Windows\Fonts\STZHONGS.TTF',width=8000, height=8060, margin=20).generate(s_str)
