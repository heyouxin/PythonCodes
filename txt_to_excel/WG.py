...
import csv
with open("csv_WG2.csv","w",newline="") as datacsv:
     #dialect为打开csv文件的方式，默认是excel，delimiter="\t"参数指写入的时候的分隔符
     csvwriter = csv.writer(datacsv,dialect = ("excel"))
     #csv文件插入一行数据，把下面列表中的每一项放入一个单元格（可以用循环插入多行）
     csvwriter.writerow(["公开（公告）号","公开（公告）日","申请号","申请日","专利号","名称","主分类号","分类号","申请（专利权）人","发明（设计）人","摘要","国省代码","地址","专利代理机构","代理人","发布路径","页数","申请国代码","专利类型","申请来源"])
